...
variable "attached_cluster_name" {
  description = "Name for the attached cluster resource as it will appear in GKE Hub (e.g. 'aws-eks-cluster-abc123'). Must be unique within the fleet project and location. Required; no default."
  type        = string
}
