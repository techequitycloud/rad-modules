...
variable "application_module" {
  ...
  validation {
    ...
    error_message = "Application module must be one of: cyclos, or leave empty for manual configuration."
  }
}
