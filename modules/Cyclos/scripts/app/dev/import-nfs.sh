...
sudo mkdir -p /share/appcyclosdemo166fdev && sudo rm -rf /share/appcyclosdemo166fdev/* && sudo chown -R nobody:nogroup /share/appcyclosdemo166fdev && sudo chmod 775 /share/appcyclosdemo166fdev
...
if [ -f "appcyclosdemo166fdev.zip" ]; then
    ...
    # Move directory
    sudo rm -rf /share/appcyclosdemo166fdev/* && sudo mv appcyclosdemo166fdev/* /share/appcyclosdemo166fdev/

    # Change ownership
    sudo chmod -R 0777 /share/appcyclosdemo166fdev && sudo chown -R nobody:nogroup /share/appcyclosdemo166fdev

    # Delete Backup from bastion host
    sudo rm -rf appcyclosdemo166fdev.zip && sudo rm -rf appcyclosdemo166fdev
fi

# Check if the shared directory exists
if [ ! -d /share/appcyclosdemo166fdev ]; then echo 'Error: /share/appcyclosdemo166fdev does not exist.'; exit 1; fi
