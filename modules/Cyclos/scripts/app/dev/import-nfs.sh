...
sudo mkdir -p /share/appcyclosdemo5e33dev && sudo rm -rf /share/appcyclosdemo5e33dev/* && sudo chown -R nobody:nogroup /share/appcyclosdemo5e33dev && sudo chmod 775 /share/appcyclosdemo5e33dev
...
if [ -f "appcyclosdemo5e33dev.zip" ]; then
    ...
    # Move directory
    sudo rm -rf /share/appcyclosdemo5e33dev/* && sudo mv appcyclosdemo5e33dev/* /share/appcyclosdemo5e33dev/

    # Change ownership
    sudo chmod -R 0777 /share/appcyclosdemo5e33dev && sudo chown -R nobody:nogroup /share/appcyclosdemo5e33dev

    # Delete Backup from bastion host
    sudo rm -rf appcyclosdemo5e33dev.zip && sudo rm -rf appcyclosdemo5e33dev
fi

# Check if the shared directory exists
if [ ! -d /share/appcyclosdemo5e33dev ]; then echo 'Error: /share/appcyclosdemo5e33dev does not exist.'; exit 1; fi
