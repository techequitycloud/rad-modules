...
sudo mkdir -p /share/appcyclosdemo5e33prod && sudo rm -rf /share/appcyclosdemo5e33prod/* && sudo chown -R nobody:nogroup /share/appcyclosdemo5e33prod && sudo chmod 775 /share/appcyclosdemo5e33prod
...
if [ -f "appcyclosdemo5e33prod.zip" ]; then
    ...
    # Move directory
    sudo rm -rf /share/appcyclosdemo5e33prod/* && sudo mv appcyclosdemo5e33prod/* /share/appcyclosdemo5e33prod/

    # Change ownership
    sudo chmod -R 0777 /share/appcyclosdemo5e33prod && sudo chown -R nobody:nogroup /share/appcyclosdemo5e33prod

    # Delete Backup from bastion host
    sudo rm -rf appcyclosdemo5e33prod.zip && sudo rm -rf appcyclosdemo5e33prod
fi

# Check if the shared directory exists
if [ ! -d /share/appcyclosdemo5e33prod ]; then echo 'Error: /share/appcyclosdemo5e33prod does not exist.'; exit 1; fi
