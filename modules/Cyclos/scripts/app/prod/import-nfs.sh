...
sudo mkdir -p /share/appcyclosdemo166fprod && sudo rm -rf /share/appcyclosdemo166fprod/* && sudo chown -R nobody:nogroup /share/appcyclosdemo166fprod && sudo chmod 775 /share/appcyclosdemo166fprod
...
if [ -f "appcyclosdemo166fprod.zip" ]; then
    ...
    # Move directory
    sudo rm -rf /share/appcyclosdemo166fprod/* && sudo mv appcyclosdemo166fprod/* /share/appcyclosdemo166fprod/

    # Change ownership
    sudo chmod -R 0777 /share/appcyclosdemo166fprod && sudo chown -R nobody:nogroup /share/appcyclosdemo166fprod

    # Delete Backup from bastion host
    sudo rm -rf appcyclosdemo166fprod.zip && sudo rm -rf appcyclosdemo166fprod
fi

# Check if the shared directory exists
if [ ! -d /share/appcyclosdemo166fprod ]; then echo 'Error: /share/appcyclosdemo166fprod does not exist.'; exit 1; fi
