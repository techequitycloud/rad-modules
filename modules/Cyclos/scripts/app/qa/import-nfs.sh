...
sudo mkdir -p /share/appcyclosdemo166fqa && sudo rm -rf /share/appcyclosdemo166fqa/* && sudo chown -R nobody:nogroup /share/appcyclosdemo166fqa && sudo chmod 775 /share/appcyclosdemo166fqa
...
if [ -f "appcyclosdemo166fqa.zip" ]; then
    ...
    # Move directory
    sudo rm -rf /share/appcyclosdemo166fqa/* && sudo mv appcyclosdemo166fqa/* /share/appcyclosdemo166fqa/

    # Change ownership
    sudo chmod -R 0777 /share/appcyclosdemo166fqa && sudo chown -R nobody:nogroup /share/appcyclosdemo166fqa

    # Delete Backup from bastion host
    sudo rm -rf appcyclosdemo166fqa.zip && sudo rm -rf appcyclosdemo166fqa
fi

# Check if the shared directory exists
if [ ! -d /share/appcyclosdemo166fqa ]; then echo 'Error: /share/appcyclosdemo166fqa does not exist.'; exit 1; fi
