...
sudo mkdir -p /share/appcyclosdemo5e33qa && sudo rm -rf /share/appcyclosdemo5e33qa/* && sudo chown -R nobody:nogroup /share/appcyclosdemo5e33qa && sudo chmod 775 /share/appcyclosdemo5e33qa
...
if [ -f "appcyclosdemo5e33qa.zip" ]; then
    ...
    # Move directory
    sudo rm -rf /share/appcyclosdemo5e33qa/* && sudo mv appcyclosdemo5e33qa/* /share/appcyclosdemo5e33qa/

    # Change ownership
    sudo chmod -R 0777 /share/appcyclosdemo5e33qa && sudo chown -R nobody:nogroup /share/appcyclosdemo5e33qa

    # Delete Backup from bastion host
    sudo rm -rf appcyclosdemo5e33qa.zip && sudo rm -rf appcyclosdemo5e33qa
fi

# Check if the shared directory exists
if [ ! -d /share/appcyclosdemo5e33qa ]; then echo 'Error: /share/appcyclosdemo5e33qa does not exist.'; exit 1; fi
