...
#
# This file provides the selection logic for using module presets.
# Individual module configurations are defined in separate .tf files.
#
# Directory Structure:
#   modules/
#   └── variables.tf    (module definition)
#########################################################################
