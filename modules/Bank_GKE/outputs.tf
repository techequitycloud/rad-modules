...
# Output the external IP address of the global load balancer
output "external_ip" {
  description = "External IP address of the Bank of Anthos application"
...
output "cluster_credentials_cmd" {
  description = "Kubernetes credentials command"
