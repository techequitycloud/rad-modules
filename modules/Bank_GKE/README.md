...
| <a name="provider_google.impersonated"></a> [google.impersonated](#provider\_google.impersonated) | 7.33.0 |
...
| <a name="input_region"></a> [region](#input\_region) | GCP region where the GKE cluster, VPC, and all supporting resources will be deployed (e.g. 'us-central1', 'europe-west1'). Defaults to 'us-central1'. Deployment may fail if sufficient resource quota is not available in the selected region. {{UIMeta group=1 order=102 }} | `string` | `"us-central1"` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_cluster_credentials_cmd"></a> [cluster\_credentials\_cmd](#output\_cluster\_credentials\_cmd) | Kubernetes cluster get-credentials command |
| <a name="output_deployment_id"></a> [deployment\_id](#output\_deployment\_id) | Module Deployment ID |
| <a name="output_external_ip"></a> [external\_ip](#output\_external\_ip) | External IP address of the Bank of Anthos load balancer |
