...
locals {
  gke_sa_project_roles = [
    # SECURITY: Removed storage.objectAdmin to enforce least-privilege, preventing the
    # GKE service account from having project-wide write access to all GCS buckets.
    # storage.objectViewer remains to allow pulling container images.
