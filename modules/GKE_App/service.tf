    ...
    template {
      ...
      containers {
        ...
        env {
          ...
          value_source {
            secret_key_ref {
              secret = local.sql_server_exists ? "${local.db_instance_name}-${var.application_database_name}dev-password-${var.tenant_deployment_id}-${local.random_id}" : "${local.db_instance_name}-${var.application_database_name}dev-password-${var.tenant_deployment_id}-${local.random_id}"
              version = "latest"
            }
          }
        }
        ...
        env {
          name  = "DB_HOST"
          value = local.sql_server_exists ? "${local.db_internal_ip}" : "${local.db_internal_ip}"
        }
    ...
    template {
      ...
      containers {
        ...
        env {
          ...
          value_source {
            secret_key_ref {
              secret = local.sql_server_exists ? "${local.db_instance_name}-${var.application_database_name}qa-password-${var.tenant_deployment_id}-${local.random_id}" : "${local.db_instance_name}-${var.application_database_name}qa-password-${var.tenant_deployment_id}-${local.random_id}"
              version = "latest"
            }
          }
        }
    ...
    template {
      ...
      containers {
        ...
        env {
          ...
          value_source {
            secret_key_ref {
              secret = local.sql_server_exists ? "${local.db_instance_name}-${var.application_database_name}prod-password-${var.tenant_deployment_id}-${local.random_id}" : "${local.db_instance_name}-${var.application_database_name}prod-password-${var.tenant_deployment_id}-${local.random_id}"
              version = "latest"
            }
          }
        }
