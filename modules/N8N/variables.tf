...
variable "application_module" {
  ...
  validation {
    ...
    error_message = "Application module must be one of: n8n, or leave empty for manual configuration."
  }
}
