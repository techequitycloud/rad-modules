...
resource "github_repository_file" "primary_dev_base_kustomization" {
  ...
  depends_on = [local_file.primary_dev_base_kustomization, github_branch.branches]
}
...
resource "github_repository_file" "secondary_dev_base_kustomization" {
  ...
  depends_on = [local_file.secondary_dev_base_kustomization, github_branch.branches]
}
...
resource "github_repository_file" "primary_dev_overlay_kustomization" {
  ...
  depends_on = [local_file.primary_dev_overlay_kustomization, github_branch.branches]
}
...
resource "github_repository_file" "secondary_dev_overlay_kustomization" {
  ...
  depends_on = [local_file.secondary_dev_overlay_kustomization, github_branch.branches]
}
...
resource "github_repository_file" "primary_dev_base_deploy" {
  ...
  depends_on = [local_file.primary_dev_base_deploy, github_branch.branches]
}
...
resource "github_repository_file" "secondary_dev_base_deploy" {
  ...
  depends_on = [local_file.secondary_dev_base_deploy, github_branch.branches]
}
...
resource "github_repository_file" "primary_dev_overlay_deploy" {
  ...
  depends_on = [local_file.primary_dev_overlay_deploy, github_branch.branches]
}
...
resource "github_repository_file" "secondary_dev_overlay_deploy" {
  ...
  depends_on = [local_file.secondary_dev_overlay_deploy, github_branch.branches]
}
...
resource "github_repository_file" "dev_foreground" {
  ...
  depends_on      = [local_file.dev_foreground, github_branch.branches]
}
...
resource "github_repository_file" "dev_cloudrun_entrypoint" {
  ...
  depends_on = [local_file.dev_cloudrun_entrypoint, github_branch.branches]
}
...
resource "github_repository_file" "dev_cloudbuild" {
  ...
  depends_on      = [local_file.dev_cloudbuild, github_branch.branches]
}
...
resource "github_repository_file" "dev_dockerfile" {
  ...
  depends_on      = [local_file.dev_dockerfile, github_branch.branches]
}
...
resource "github_repository_file" "dev_skaffold" {
  ...
  depends_on      = [local_file.dev_skaffold, github_branch.branches]
}
