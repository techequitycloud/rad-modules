...
resource "github_repository_file" "primary_qa_base_kustomization" {
  ...
  depends_on = [local_file.primary_qa_base_kustomization, github_branch.branches]
}
...
resource "github_repository_file" "secondary_qa_base_kustomization" {
  ...
  depends_on = [local_file.secondary_qa_base_kustomization, github_branch.branches]
}
...
resource "github_repository_file" "primary_qa_overlay_kustomization" {
  ...
  depends_on = [local_file.primary_qa_overlay_kustomization, github_branch.branches]
}
...
resource "github_repository_file" "secondary_qa_overlay_kustomization" {
  ...
  depends_on = [local_file.secondary_qa_overlay_kustomization, github_branch.branches]
}
...
resource "github_repository_file" "primary_qa_base_deploy" {
  ...
  depends_on = [local_file.primary_qa_base_deploy, github_branch.branches]
}
...
resource "github_repository_file" "secondary_qa_base_deploy" {
  ...
  depends_on = [local_file.secondary_qa_base_deploy, github_branch.branches]
}
...
resource "github_repository_file" "primary_qa_overlay_deploy" {
  ...
  depends_on = [local_file.primary_qa_overlay_deploy, github_branch.branches]
}
...
resource "github_repository_file" "secondary_qa_overlay_deploy" {
  ...
  depends_on = [local_file.secondary_qa_overlay_deploy, github_branch.branches]
}
...
resource "github_repository_file" "qa_foreground" {
  ...
  depends_on = [local_file.qa_foreground, github_branch.branches]
}
...
resource "github_repository_file" "qa_cloudrun_entrypoint" {
  ...
  depends_on = [local_file.qa_cloudrun_entrypoint, github_branch.branches]
}
...
resource "github_repository_file" "qa_dockerfile" {
  ...
  depends_on = [local_file.qa_dockerfile, github_branch.branches]
}
...
resource "github_repository_file" "qa_cloudbuild" {
  ...
  depends_on      = [local_file.qa_cloudbuild, github_branch.branches]
}
...
resource "github_repository_file" "qa_skaffold" {
  ...
  depends_on = [local_file.qa_skaffold, github_branch.branches]
}
