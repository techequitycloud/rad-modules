...
module "webapp" {
  ...
  environment_variables = merge(var.environment_variables, {
    WORDPRESS_DB_NAME = module.webapp.database_name
    WORDPRESS_DB_USER = module.webapp.database_user
    WORDPRESS_DB_HOST = module.webapp.database_host
    WORDPRESS_DEBUG   = "false"
  })

  # DB Password
  secret_environment_variables = {
    WORDPRESS_DB_PASSWORD = module.webapp.database_password_secret
  }
}
