...
locals {
  ...
  enable_backup_import       = local.final_enable_backup_import
  backup_source              = local.final_backup_source
  backup_uri                 = local.final_backup_uri
  backup_format              = local.final_backup_format
