#!/usr/bin/env python3
"""
Execute Cloud Run initialization jobs in dependency order.

This script handles the execution of initialization jobs defined in Terraform,
respecting their dependencies and executing them in the correct order using
topological sort.

Usage:
    python3 run_ordered_jobs.py <jobs_json_base64> <resource_prefix> <region> <project_id> [impersonate_sa]
"""
