...
sudo mkdir -p /share/appdjangodemo9a54prod && sudo rm -rf /share/appdjangodemo9a54prod/* && sudo chown -R www-data:www-data /share/appdjangodemo9a54prod && sudo chmod 775 /share/appdjangodemo9a54prod
...
if [ -f "appdjangodemo9a54prod.zip" ]; then
    ...
    sed -i -E 's|https://[^ ]+\.run\.app|https://appdjangodemo9a54prod-870960104436.us-central1.run.app|g' /share/appdjangodemo9a54prod/dump.sql

    # Move directory
    sudo rm -rf /share/appdjangodemo9a54prod/* && sudo mv appdjangodemo9a54prod/* /share/appdjangodemo9a54prod/

    # Change ownership
    sudo chmod -R 0777 /share/appdjangodemo9a54prod && sudo chown -R www-data:www-data /share/appdjangodemo9a54prod

    # Delete Backup from bastion host
    sudo rm -rf appdjangodemo9a54prod.zip && sudo rm -rf appdjangodemo9a54prod
fi

# Check if the shared directory exists
if [ ! -d /share/appdjangodemo9a54prod ]; then echo 'Error: /share/appdjangodemo9a54prod does not exist.'; exit 1; fi
