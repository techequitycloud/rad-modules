...
sudo mkdir -p /share/appdjangodemo9a54qa && sudo rm -rf /share/appdjangodemo9a54qa/* && sudo chown -R www-data:www-data /share/appdjangodemo9a54qa && sudo chmod 775 /share/appdjangodemo9a54qa
...
if [ -f "appdjangodemo9a54qa.zip" ]; then
    ...
    sed -i -E 's|https://[^ ]+\.run\.app|https://appdjangodemo9a54qa-870960104436.us-central1.run.app|g' /share/appdjangodemo9a54qa/dump.sql

    # Move directory
    sudo rm -rf /share/appdjangodemo9a54qa/* && sudo mv appdjangodemo9a54qa/* /share/appdjangodemo9a54qa/

    # Change ownership
    sudo chmod -R 0777 /share/appdjangodemo9a54qa && sudo chown -R www-data:www-data /share/appdjangodemo9a54qa

    # Delete Backup from bastion host
    sudo rm -rf appdjangodemo9a54qa.zip && sudo rm -rf appdjangodemo9a54qa
fi

# Check if the shared directory exists
if [ ! -d /share/appdjangodemo9a54qa ]; then echo 'Error: /share/appdjangodemo9a54qa does not exist.'; exit 1; fi
