...
sudo mkdir -p /share/appdjangodemo9a54dev && sudo rm -rf /share/appdjangodemo9a54dev/* && sudo chown -R www-data:www-data /share/appdjangodemo9a54dev && sudo chmod 775 /share/appdjangodemo9a54dev
...
if [ -f "appdjangodemo9a54dev.zip" ]; then
    ...
    sed -i -E 's|https://[^ ]+\.run\.app|https://appdjangodemo9a54dev-870960104436.us-central1.run.app|g' /share/appdjangodemo9a54dev/dump.sql

    # Move directory
    sudo rm -rf /share/appdjangodemo9a54dev/* && sudo mv appdjangodemo9a54dev/* /share/appdjangodemo9a54dev/

    # Change ownership
    sudo chmod -R 0777 /share/appdjangodemo9a54dev && sudo chown -R www-data:www-data /share/appdjangodemo9a54dev

    # Delete Backup from bastion host
    sudo rm -rf appdjangodemo9a54dev.zip && sudo rm -rf appdjangodemo9a54dev
fi

# Check if the shared directory exists
if [ ! -d /share/appdjangodemo9a54dev ]; then echo 'Error: /share/appdjangodemo9a54dev does not exist.'; exit 1; fi
