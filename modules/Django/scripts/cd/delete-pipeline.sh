...
# Delete services
delete_cloud_run_service "${APP_NAME}"
delete_cloud_run_job "${APP_NAME}"
...
gcloud --project $PROJECT_ID deploy targets delete ${TARGET_NAME} --region=${APP_REGION} --quiet $SA_ARG || true
