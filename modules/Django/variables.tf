...
variable "application_module" {
  ...
  validation {
    ...
    error_message = "Application module must be one of: django, or leave empty for manual configuration."
  }
}
