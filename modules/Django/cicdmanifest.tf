...
# Resource for creating djangocron local script directly from an existing file.
...
# Resource definition for a GitHub repository file for the djangocron script
