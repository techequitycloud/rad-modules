...
variable "module_description" {
  ...
  type        = string
  default     = "This module can be used to deploy Odoo"
}
...
variable "application_display_name" {
  ...
  type        = string
  default     = "Odoo Community Edition"
}
