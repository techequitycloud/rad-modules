...
variable "tenant_deployment_id" {
  description = "Specify a tenant deployment id. This identifies the client or application deployment. A random 4 digit identifier is added to make the deployment unique. {{UIMeta group=3 order=701 updatesafe}}"
  type        = string
}
