...
resource "null_resource" "build_cloud_deploy_app_pipeline" {
  ...
  provisioner "local-exec" {
    ...
    working_dir = "${path.module}/scripts/cd/app"  
  ...
  depends_on = [
    ...
    local_file.clouddeploy_dev_service_dns,
    ...
    local_file.clouddeploy_dev_statefulset_app,
    ...
    local_file.clouddeploy_qa_service_dns,
    ...
    local_file.clouddeploy_qa_statefulset_app,
    ...
    local_file.clouddeploy_prod_service_dns,
    ...
    local_file.clouddeploy_prod_statefulset_app,
