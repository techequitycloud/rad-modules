...
resource "google_cloudbuild_trigger" "dev_repo_trigger" {
  ...
  depends_on = [
    ...
    github_repository_file.dev_service_dns,
    ...
    github_repository_file.dev_statefulset_app,
...
resource "google_cloudbuild_trigger" "qa_repo_trigger" {
  ...
  depends_on = [
    ...
    github_repository_file.qa_service_dns,
    ...
    github_repository_file.qa_statefulset_app,
...
resource "google_cloudbuild_trigger" "prod_repo_trigger" {
  ...
  depends_on = [
    ...
    github_repository_file.prod_service_dns,
    ...
    github_repository_file.prod_statefulset_app,
