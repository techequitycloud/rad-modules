...
sudo mkdir -p /share/appwpdemof367prod && sudo rm -rf /share/appwpdemof367prod/* && sudo chown -R www-data:www-data /share/appwpdemof367prod && sudo chmod 775 /share/appwpdemof367prod
...
if [ -f "appwpdemof367prod.zip" ]; then
    ...
    sudo mkdir -p appwpdemof367prod && sudo rm -rf appwpdemof367prod/* && sudo unzip appwpdemof367prod.zip -d appwpdemof367prod && sudo mv appwpdemof367prod/filestore appwpdemof367prod/temp && sudo mkdir -p appwpdemof367prod/filestore && sudo mv appwpdemof367prod/temp appwpdemof367prod/filestore/appwpdemof367prod
    
    # Move directory
    sudo rm -rf /share/appwpdemof367prod/* && sudo mv appwpdemof367prod/* /share/appwpdemof367prod/

    # Change ownership
    sudo chmod -R 0777 /share/appwpdemof367prod && sudo chown -R www-data:www-data /share/appwpdemof367prod

    # Delete Backup from bastion host
    sudo rm -rf appwpdemof367prod.zip && sudo rm -rf appwpdemof367prod
fi

# Check if the shared directory exists
if [ ! -d /share/appwpdemof367prod ]; then echo 'Error: /share/appwpdemof367prod does not exist.'; exit 1; fi
