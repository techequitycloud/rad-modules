...
sudo mkdir -p /share/appwpdemof367dev && sudo rm -rf /share/appwpdemof367dev/* && sudo chown -R www-data:www-data /share/appwpdemof367dev && sudo chmod 775 /share/appwpdemof367dev
...
if [ -f "appwpdemof367dev.zip" ]; then
    ...
    sudo mkdir -p appwpdemof367dev && sudo rm -rf appwpdemof367dev/* && sudo unzip appwpdemof367dev.zip -d appwpdemof367dev && sudo mv appwpdemof367dev/filestore appwpdemof367dev/temp && sudo mkdir -p appwpdemof367dev/filestore && sudo mv appwpdemof367dev/temp appwpdemof367dev/filestore/appwpdemof367dev
    
    # Move directory
    sudo rm -rf /share/appwpdemof367dev/* && sudo mv appwpdemof367dev/* /share/appwpdemof367dev/

    # Change ownership
    sudo chmod -R 0777 /share/appwpdemof367dev && sudo chown -R www-data:www-data /share/appwpdemof367dev

    # Delete Backup from bastion host
    sudo rm -rf appwpdemof367dev.zip && sudo rm -rf appwpdemof367dev
fi

# Check if the shared directory exists
if [ ! -d /share/appwpdemof367dev ]; then echo 'Error: /share/appwpdemof367dev does not exist.'; exit 1; fi
