...
sudo mkdir -p /share/appwpdemof367qa && sudo rm -rf /share/appwpdemof367qa/* && sudo chown -R www-data:www-data /share/appwpdemof367qa && sudo chmod 775 /share/appwpdemof367qa
...
if [ -f "appwpdemof367qa.zip" ]; then
    ...
    sudo mkdir -p appwpdemof367qa && sudo rm -rf appwpdemof367qa/* && sudo unzip appwpdemof367qa.zip -d appwpdemof367qa && sudo mv appwpdemof367qa/filestore appwpdemof367qa/temp && sudo mkdir -p appwpdemof367qa/filestore && sudo mv appwpdemof367qa/temp appwpdemof367qa/filestore/appwpdemof367qa
    
    # Move directory
    sudo rm -rf /share/appwpdemof367qa/* && sudo mv appwpdemof367qa/* /share/appwpdemof367qa/

    # Change ownership
    sudo chmod -R 0777 /share/appwpdemof367qa && sudo chown -R www-data:www-data /share/appwpdemof367qa

    # Delete Backup from bastion host
    sudo rm -rf appwpdemof367qa.zip && sudo rm -rf appwpdemof367qa
fi

# Check if the shared directory exists
if [ ! -d /share/appwpdemof367qa ]; then echo 'Error: /share/appwpdemof367qa does not exist.'; exit 1; fi
