...
sudo mkdir -p /share/${DB_USER} && sudo rm -rf /share/${DB_USER}/* && sudo chown -R nobody:nogroup /share/${DB_USER} && sudo chmod 775 /share/${DB_USER}
...
if [ -f "${DB_NAME}.zip" ]; then
    ...
    sudo mkdir -p ${DB_NAME} && sudo rm -rf ${DB_NAME}/* && sudo unzip ${DB_NAME}.zip -d ${DB_NAME} && sudo mv ${DB_NAME}/filestore ${DB_NAME}/temp && sudo mkdir -p ${DB_NAME}/filestore && sudo mv ${DB_NAME}/temp ${DB_NAME}/filestore/${DB_NAME}
    
    # Move directory
    sudo rm -rf /share/${DB_USER}/* && sudo mv ${DB_NAME}/* /share/${DB_USER}/

    # Change ownership
    sudo chmod -R 0777 /share/${DB_USER} && sudo chown -R nobody:nogroup /share/${DB_USER}
