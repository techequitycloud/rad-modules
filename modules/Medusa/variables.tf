...
variable "module_description" {
  ...
  type        = string
  default     = "This module can be used to deploy Medusa"
}
...
variable "application_module" {
  ...
  validation {
    ...
    error_message = "Application module must be one of: medusa, or leave empty for manual configuration."
  }
}
