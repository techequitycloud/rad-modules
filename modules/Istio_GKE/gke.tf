...
locals {
  gke_sa_project_roles = [
    # SECURITY: GKE node pools only require read access to pull images. Using storage.objectAdmin allows broad write access, risking data modification if a pod is compromised.
