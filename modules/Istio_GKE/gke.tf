...
locals {
  gke_sa_project_roles = [
    # SECURITY: Replaced storage.objectAdmin with storage.objectViewer to enforce least-privilege
    # and prevent the GKE service account from having project-wide write access to all GCS buckets.
