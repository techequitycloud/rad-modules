...
locals {
  gke_sa_project_roles = [
    # 🛡️ Sentinel: Enforce least privilege for GKE Node SA.
    # Omit roles/storage.objectAdmin to prevent project-wide destructive access,
    # use roles/storage.objectViewer instead. If apps need write access, use Workload Identity.
