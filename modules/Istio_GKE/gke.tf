...
locals {
  gke_sa_project_roles = [
    # SECURITY FIX: Replaced roles/storage.objectAdmin with roles/storage.objectViewer to enforce least privilege.
    # Service accounts should not have project-wide objectAdmin access as it grants destructive permissions.
