...
variable "application_module" {
  ...
  validation {
    ...
    error_message = "Application module must be one of: strapi, or leave empty for manual configuration."
  }
}
