...
# Generate wrapper-specific random ID for wrapper resources to avoid cycles
...
locals {
  ...
  # PostgreSQL vs MySQL socket paths
  ...
  # Calculate predictable Cloud Run URL
  ...
  # Service accounts
  cloudrun_service_account   = var.cloudrun_service_account != null && var.cloudrun_service_account != "" ? var.cloudrun_service_account : "cloudrun-sa"
