...
resource "null_resource" "create_nfs_directories_on_server" {
  ...
  triggers = {
    ...
    qa_path = "/share/app${var.application_database_name}${var.tenant_deployment_id}${local.random_id}qa"
    prod_path = "/share/app${var.application_database_name}${var.tenant_deployment_id}${local.random_id}prod"
  }
...
sudo mkdir -p /share/app${var.application_database_name}${var.tenant_deployment_id}${local.random_id}qa
sudo mkdir -p /share/app${var.application_database_name}${var.tenant_deployment_id}${local.random_id}prod
