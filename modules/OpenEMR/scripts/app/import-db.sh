...
[client]
user=root
password=0T7tYj7z7Am%gfRO
host=10.240.0.5
EOF
chmod 600 $HOME/.my.cnf

# To authorize remote connection from root user
# mysql --defaults-file=$HOME/.my.cnf -u root -h "10.240.0.5" -e "GRANT ALL PRIVILEGES ON *.* TO 'admin'@'%';"

echo "Displaying databases..."
mysql --defaults-file=$HOME/.my.cnf -u root -h "10.240.0.5" -e 'SHOW DATABASES;'
