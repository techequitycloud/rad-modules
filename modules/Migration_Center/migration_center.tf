...
# ─── Asset groups, preference sets, and reports are lab exercises ─────────────
# These Migration Center resources are created by students during the lab using
# the Cloud Console or the REST API commands in the lab guide. Creating them
# here would skip the learning objective and produce incomplete data anyway,
# since MCDCv6 discovery data only arrives after the manual OAuth + scan steps.
# ─────────────────────────────────────────────────────────────────────────────
