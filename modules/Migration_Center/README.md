...
| Output | Description |
|---|---|
| `windows_vm_external_ip` | RDP target IP — Username: `migrationcenter` / Password: (stored in Secret Manager) |
| `windows_vm_rdp_password_secret_id` | Secret Manager Secret ID containing the Windows VM RDP password |
