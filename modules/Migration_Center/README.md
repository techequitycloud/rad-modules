...
| Output | Description |
|---|---|
| `windows_vm_external_ip` | RDP target IP — Username: `migrationcenter` / Password: see `windows_vm_password` output |
...
| windows_vm_password | Password for the Windows VM RDP user (migrationcenter) |
<!-- END_TF_DOCS -->
