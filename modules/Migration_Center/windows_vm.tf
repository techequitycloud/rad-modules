...
# Ephemeral password for the Windows VM RDP user (migrationcenter).
# override_special omits single quotes to prevent PowerShell injection
# when the password is interpolated into the startup script below.
