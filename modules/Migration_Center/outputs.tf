...
output "windows_vm_external_ip" {
  description = "External IP address of the Windows VM — use this to connect via RDP. Username: migrationcenter. Password is in windows_vm_password output."
...
output "windows_vm_password" {
  description = "Password for the Windows VM RDP user (migrationcenter)."
