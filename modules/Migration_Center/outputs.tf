...
output "windows_vm_rdp_password" {
  description = "Auto-generated password for the RDP lab user 'migrationcenter'."
  value       = var.create_windows_vm ? random_password.windows_rdp_password[0].result : null
  sensitive   = true
}
