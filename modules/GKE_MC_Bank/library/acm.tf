...
resource "google_gke_hub_feature_membership" "gke_cluster_1_acm_feature_member" {
  count       = var.enable_config_management ? 1 : 0
  project     = local.project.project_id
  location    = "global"
...
resource "google_gke_hub_feature_membership" "gke_cluster_2_acm_feature_member" {
  count       = var.enable_config_management ? 1 : 0
  project     = local.project.project_id
  location    = "global"
  feature     = google_gke_hub_feature.acm_feature[0].name
