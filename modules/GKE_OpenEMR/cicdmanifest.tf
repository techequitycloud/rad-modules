...
data "local_file" "qa_auto_configure" {
  count = var.configure_continuous_integration && var.application_git_token != null && var.application_git_token != "" && var.configure_nonproduction_environment ? 1 : 0
  filename = "${path.module}/scripts/ci/auto_configure.php"
}

data "local_file" "qa_openemr_conf" {
  count = var.configure_continuous_integration && var.application_git_token != null && var.application_git_token != "" && var.configure_nonproduction_environment ? 1 : 0
  filename = "${path.module}/scripts/ci/openemr.conf"
}

data "local_file" "qa_ssl" {
  count = var.configure_continuous_integration && var.application_git_token != null && var.application_git_token != "" && var.configure_nonproduction_environment ? 1 : 0
  filename = "${path.module}/scripts/ci/ssl.sh"
}

data "local_file" "qa_xdebug" {
  count = var.configure_continuous_integration && var.application_git_token != null && var.application_git_token != "" && var.configure_nonproduction_environment ? 1 : 0
  filename = "${path.module}/scripts/ci/xdebug.sh"
}

data "local_file" "qa_cloudrun_entrypoint" {
  count = var.configure_continuous_integration && var.application_git_token != null && var.application_git_token != "" && var.configure_nonproduction_environment ? 1 : 0
  filename = "${path.module}/scripts/ci/cloudrun-entrypoint.sh"
}

data "local_file" "qa_php_ini" {
  count = var.configure_continuous_integration && var.application_git_token != null && var.application_git_token != "" && var.configure_nonproduction_environment ? 1 : 0
  filename = "${path.module}/scripts/ci/php.ini"
}

data "local_file" "qa_openemr" {
  count = var.configure_continuous_integration && var.application_git_token != null && var.application_git_token != "" && var.configure_nonproduction_environment ? 1 : 0
  filename = "${path.module}/scripts/ci/openemr.sh"
}
...
data "local_file" "prod_auto_configure" {
  count = var.configure_continuous_integration && var.application_git_token != null && var.application_git_token != "" && var.configure_production_environment ? 1 : 0
  filename = "${path.module}/scripts/ci/auto_configure.php"
}

data "local_file" "prod_openemr_conf" {
  count = var.configure_continuous_integration && var.application_git_token != null && var.application_git_token != "" && var.configure_nonproduction_environment ? 1 : 0
  filename = "${path.module}/scripts/ci/openemr.conf"
}

data "local_file" "prod_ssl" {
  count = var.configure_continuous_integration && var.application_git_token != null && var.application_git_token != "" && var.configure_nonproduction_environment ? 1 : 0
  filename = "${path.module}/scripts/ci/ssl.sh"
}

data "local_file" "prod_php_ini" {
  count = var.configure_continuous_integration && var.application_git_token != null && var.application_git_token != "" && var.configure_nonproduction_environment ? 1 : 0
  filename = "${path.module}/scripts/ci/php.ini"
} 

data "local_file" "prod_openemr" {
  count = var.configure_continuous_integration && var.application_git_token != null && var.application_git_token != "" && var.configure_production_environment ? 1 : 0
  filename = "${path.module}/scripts/ci/openemr.sh"
}

data "local_file" "prod_xdebug" {
  count = var.configure_continuous_integration && var.application_git_token != null && var.application_git_token != "" && var.configure_production_environment ? 1 : 0
  filename = "${path.module}/scripts/ci/xdebug.sh"
}

data "local_file" "prod_cloudrun_entrypoint" {
  count = var.configure_continuous_integration && var.application_git_token != null && var.application_git_token != "" && var.configure_production_environment ? 1 : 0
  filename = "${path.module}/scripts/ci/cloudrun-entrypoint.sh"
}
...
# Resource definition for a GitHub repository file for the auto_configure script
resource "github_repository_file" "dev_auto_configure" {
  count               = var.configure_continuous_integration && var.application_git_token != null && var.application_git_token != "" && var.configure_development_environment ? 1 : 0
  repository          = "${local.project.project_id}-${var.application_name}-${var.tenant_deployment_id}-${local.random_id}"
  branch              = "dev"
  commit_message      = "Add file to repo"
  overwrite_on_create = true
  file                = "auto_configure.php"
  content             = data.local_file.dev_auto_configure[count.index].content
...
# Resource definition for a GitHub repository file for the auto_configure script
resource "github_repository_file" "qa_auto_configure" {
  count               = var.configure_continuous_integration && var.application_git_token != null && var.application_git_token != "" && var.configure_nonproduction_environment ? 1 : 0
  repository          = "${local.project.project_id}-${var.application_name}-${var.tenant_deployment_id}-${local.random_id}"
  branch              = "qa"
  commit_message      = "Add file to repo"
  overwrite_on_create = true
  file                = "auto_configure.php"
  content             = data.local_file.qa_auto_configure[count.index].content
...
# Resource definition for a GitHub repository file for the configuration
resource "github_repository_file" "qa_php_ini" {
  count               = var.configure_continuous_integration && var.application_git_token != null && var.application_git_token != "" && var.configure_nonproduction_environment ? 1 : 0
  repository          = "${local.project.project_id}-${var.application_name}-${var.tenant_deployment_id}-${local.random_id}"
  branch              = "qa"
  commit_message      = "Add file to repo"
  overwrite_on_create = true
  file                = "php.ini"
  content             = data.local_file.qa_php_ini[count.index].content
...
# Resource definition for a GitHub repository file for the configuration
resource "github_repository_file" "qa_openemr_conf" {
  count               = var.configure_continuous_integration && var.application_git_token != null && var.application_git_token != "" && var.configure_nonproduction_environment ? 1 : 0
  repository          = "${local.project.project_id}-${var.application_name}-${var.tenant_deployment_id}-${local.random_id}"
  branch              = "qa"
  commit_message      = "Add file to repo"
  overwrite_on_create = true
  file                = "openemr.conf"
  content             = data.local_file.qa_openemr_conf[count.index].content
...
# Resource definition for a GitHub repository file for the script
resource "github_repository_file" "qa_openemr" {
  count               = var.configure_continuous_integration && var.application_git_token != null && var.application_git_token != "" && var.configure_nonproduction_environment ? 1 : 0
  repository          = "${local.project.project_id}-${var.application_name}-${var.tenant_deployment_id}-${local.random_id}"
  branch              = "qa"
  commit_message      = "Add file to repo"
  overwrite_on_create = true
  file                = "openemr.sh"
  content             = data.local_file.qa_openemr[count.index].content
...
# Resource definition for a GitHub repository file for the script
resource "github_repository_file" "qa_ssl" {
  count               = var.configure_continuous_integration && var.application_git_token != null && var.application_git_token != "" && var.configure_nonproduction_environment ? 1 : 0
  repository          = "${local.project.project_id}-${var.application_name}-${var.tenant_deployment_id}-${local.random_id}"
  branch              = "qa"
  commit_message      = "Add file to repo"
  overwrite_on_create = true
  file                = "ssl.sh"
  content             = data.local_file.qa_ssl[count.index].content
...
# Resource definition for a GitHub repository file for the script
resource "github_repository_file" "qa_xdebug" {
  count               = var.configure_continuous_integration && var.application_git_token != null && var.application_git_token != "" && var.configure_nonproduction_environment ? 1 : 0
  repository          = "${local.project.project_id}-${var.application_name}-${var.tenant_deployment_id}-${local.random_id}"
  branch              = "qa"
  commit_message      = "Add file to repo"
  overwrite_on_create = true
  file                = "xdebug.sh"
  content             = data.local_file.qa_xdebug[count.index].content
...
resource "github_repository_file" "qa_cloudrun_entrypoint" {
  ...
  overwrite_on_create = true
  file                = "cloudrun-entrypoint.sh"
  content             = data.local_file.qa_cloudrun_entrypoint[count.index].content
...
# Resource definition for a moodle config file for the Cloud Run application
resource "github_repository_file" "prod_openemr_conf" {
  count               = var.configure_continuous_integration && var.application_git_token != null && var.application_git_token != "" && var.configure_production_environment ? 1 : 0
  repository          = "${local.project.project_id}-${var.application_name}-${var.tenant_deployment_id}-${local.random_id}"
  branch              = "prod"
  commit_message      = "Add file to repo"
  overwrite_on_create = true
  file                = "openemr.conf"
  content             = data.local_file.prod_openemr_conf[count.index].content
...
# Resource definition for a moodle config file for the Cloud Run application
resource "github_repository_file" "prod_php_ini" {
  count               = var.configure_continuous_integration && var.application_git_token != null && var.application_git_token != "" && var.configure_production_environment ? 1 : 0
  repository          = "${local.project.project_id}-${var.application_name}-${var.tenant_deployment_id}-${local.random_id}"
  branch              = "prod"
  commit_message      = "Add file to repo"
  overwrite_on_create = true
  file                = "php.ini"
  content             = data.local_file.prod_php_ini[count.index].content
...
# Resource definition for a GitHub repository file 
resource "github_repository_file" "prod_openemr" {
  count               = var.configure_continuous_integration && var.application_git_token != null && var.application_git_token != "" && var.configure_production_environment ? 1 : 0
  repository          = "${local.project.project_id}-${var.application_name}-${var.tenant_deployment_id}-${local.random_id}"
  branch              = "prod"
  commit_message      = "Add file to repo"
  overwrite_on_create = true
  file                = "openemr.sh"
  content             = data.local_file.prod_openemr[count.index].content
...
# Resource definition for a GitHub repository file 
resource "github_repository_file" "prod_ssl" {
  count               = var.configure_continuous_integration && var.application_git_token != null && var.application_git_token != "" && var.configure_production_environment ? 1 : 0
  repository          = "${local.project.project_id}-${var.application_name}-${var.tenant_deployment_id}-${local.random_id}"
  branch              = "prod"
  commit_message      = "Add file to repo"
  overwrite_on_create = true
  file                = "ssl.sh"
  content             = data.local_file.prod_ssl[count.index].content
...
# Resource definition for a GitHub repository file 
resource "github_repository_file" "prod_xdebug" {
  count               = var.configure_continuous_integration && var.application_git_token != null && var.application_git_token != "" && var.configure_production_environment ? 1 : 0
  repository          = "${local.project.project_id}-${var.application_name}-${var.tenant_deployment_id}-${local.random_id}"
  branch              = "prod"
  commit_message      = "Add file to repo"
  overwrite_on_create = true
  file                = "xdebug.sh"
  content             = data.local_file.prod_xdebug[count.index].content
...
resource "github_repository_file" "prod_cloudrun_entrypoint" {
  ...
  overwrite_on_create = true
  file                = "cloudrun-entrypoint.sh"
  content             = data.local_file.prod_cloudrun_entrypoint[count.index].content

  # Ensure that the local file is created and prod branch exists before this file is added to the repository
  depends_on = [
    data.local_file.prod_cloudrun_entrypoint,
    null_resource.init_git_repo
  ]
...
resource "github_repository_file" "prod_auto_configure" {
  count               = var.configure_continuous_integration && var.application_git_token != null && var.application_git_token != "" && var.configure_production_environment ? 1 : 0
  repository          = "${local.project.project_id}-${var.application_name}-${var.tenant_deployment_id}-${local.random_id}"
  branch              = "prod"
  commit_message      = "Add file to repo"
  ...
  content             = data.local_file.prod_auto_configure[count.index].content
