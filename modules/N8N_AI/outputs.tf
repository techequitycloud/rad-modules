...
output "qdrant_service_url" {
  value = length(google_cloud_run_v2_service.qdrant_service) > 0 ? google_cloud_run_v2_service.qdrant_service[0].uri : null
}

output "ollama_service_url" {
  value = length(google_cloud_run_v2_service.ollama_service) > 0 ? google_cloud_run_v2_service.ollama_service[0].uri : null
}
