...
variable "module_description" {
  ...
  type        = string
  default     = "This module can be used to deploy N8N"
}
...
# ===========================
# GROUP 14: AI Components
# ===========================

variable "enable_ai_components" {
  description = "Set to true to enable AI components (Qdrant, Ollama). {{UIMeta group=0 order=1401 }}"
  type        = bool
  default     = true
}

variable "enable_qdrant" {
  description = "Set to true to enable Qdrant vector database. Requires enable_ai_components=true. {{UIMeta group=0 order=1402 }}"
  type        = bool
  default     = true
}

variable "qdrant_version" {
  description = "Qdrant Docker image version/tag. {{UIMeta group=0 order=1403 }}"
  type        = string
  default     = "latest"
}

variable "enable_ollama" {
  description = "Set to true to enable Ollama LLM provider. Requires enable_ai_components=true. {{UIMeta group=0 order=1404 }}"
  type        = bool
  default     = true
}

variable "ollama_version" {
  description = "Ollama Docker image version/tag. {{UIMeta group=0 order=1405 }}"
  type        = string
  default     = "latest"
}

variable "ollama_model" {
  description = "The Ollama model to pull on startup (if script implemented) or for documentation. Default is llama3.2. {{UIMeta group=0 order=1406 }}"
  type        = string
  default     = "llama3.2"
}

# ===========================
# GROUP 3: Application Configuration (Missing Variables)
# ===========================
