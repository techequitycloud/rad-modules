...
variable "module_description" {
  ...
  type        = string
  default     = "This module can be used to deploy the Sample application."
}
...
variable "application_module" {
  ...
  validation {
    ...
    error_message = "Application module must be 'sample' or leave empty for manual configuration."
  }
}
