...
variable "context" {
  description = "Kubernetes context name within the kubeconfig file that identifies the target cluster (e.g. 'aks-cluster-westus2'). Required; no default. Run 'kubectl config get-contexts' to list available contexts in your kubeconfig."
  type        = string
}
