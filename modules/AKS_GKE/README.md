...
| <a name="input_public_access"></a> [public\_access](#input\_public\_access) | Set to true to make this module visible and deployable by all platform users. Set to false (default) to restrict the module to platform administrators only. | `bool` | `false` | no |
