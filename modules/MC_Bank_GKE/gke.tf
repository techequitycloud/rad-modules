...
provider "kubernetes" {
  ...
  cluster_ca_certificate = base64decode(
    try(google_container_cluster.gke_cluster["cluster1"].master_auth[0], {cluster_ca_certificate = ""}).cluster_ca_certificate,
  )
}
...
provider "kubernetes" {
  ...
  token    = data.google_client_config.gke_cluster.access_token
  cluster_ca_certificate = base64decode(
    try(google_container_cluster.gke_cluster["cluster2"].master_auth[0], {cluster_ca_certificate = ""}).cluster_ca_certificate,
  )
}
...
provider "kubernetes" {
  ...
  token    = data.google_client_config.gke_cluster.access_token
  cluster_ca_certificate = base64decode(
    try(google_container_cluster.gke_cluster["cluster3"].master_auth[0], {cluster_ca_certificate = ""}).cluster_ca_certificate,
  )
}
...
provider "kubernetes" {
  ...
  token    = data.google_client_config.gke_cluster.access_token
  cluster_ca_certificate = base64decode(
    try(google_container_cluster.gke_cluster["cluster4"].master_auth[0], {cluster_ca_certificate = ""}).cluster_ca_certificate,
  )
}
