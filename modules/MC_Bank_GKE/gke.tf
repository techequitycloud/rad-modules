...
locals {
  # SECURITY (Sentinel): Removed roles/storage.objectAdmin from default node service account
  # to prevent project-wide destructive access to GCS buckets. Nodes only need Viewer access
  # to pull images and configurations.
