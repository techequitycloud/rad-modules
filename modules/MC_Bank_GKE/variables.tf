...
variable "module_services" {
  ...
  type        = list(string)
  default     = ["GCP", "GKE", "Anthos Service Mesh", "Cloud IAM", "Cloud Networking", "VPC Network", "Config Sync", "GKE Fleet", "Workload Identity", "Cloud Load Balancing", "Cloud NAT", "Static IP"]
}
