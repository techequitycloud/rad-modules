...
resource "kubernetes_namespace_v1" "bank_of_anthos_cluster1" {
...
resource "kubernetes_namespace_v1" "bank_of_anthos_cluster2" {
...
" "$FILTERED_MANIFESTS_DIR/accounts-db.yaml" "$FILTERED_MANIFESTS_DIR/ledger-db.yaml"
  ...
  depends_on = [
    ...
    kubernetes_namespace_v1.bank_of_anthos_cluster1,
    kubernetes_namespace_v1.bank_of_anthos_cluster2,
